...
void cifrarCesar(char *texto, int desplazamiento) {
    ...
    for (i = 0; texto[i] != '\0'; i++) {
        ...
        if (letra >= 'A' && letra <= 'Z') {
            letra = (letra - 'A' + desplazamiento) % 26 + 'A'; // Cifrar
        }
    ...
    resultado[i] = '\0'; // Agregar el terminador de cadena
...
void decodificarCesar(char *texto, int desplazamiento) {
    ...
    for (i = 0; texto[i] != '\0'; i++) {
        ...
        // Verificar si es una letra mayúscula
        if (letra >= 'A' && letra <= 'Z') {
            letra = (letra - 'A' - desplazamiento + 26) % 26 + 'A'; // Decodificar
        }
        // Verificar si es una letra minúscula
        else if (letra >= 'a' && letra <= 'z') {
            letra = (letra - 'a' - desplazamiento + 26) % 26 + 'a'; // Decodificar
...
void limpiarPantalla() {
    // Limpiar la pantalla (funciona en Windows)
    system("cls");
}
int main() {
    char texto[100];
    ...
    do {
        ...
        switch (opcion) {
            case 1:
                ...
                getchar(); // Limpiar el buffer de entrada
                do {
                    limpiarPantalla(); // Limpiar la pantalla antes de cifrar
                    printf("Ingrese el texto a cifrar: ");
                    fgets(texto, sizeof(texto), stdin);
                    texto[strcspn(texto, "\n")] = 0; // Eliminar el salto de línea
                    cifrarCesar(texto, desplazamiento);
                    printf("¿Desea cifrar otro texto? (S/N): ");
                    continuar = getchar();
                    getchar(); // Limpiar el buffer de entrada
            ...
            case 2:
                ...
                getchar(); // Limpiar el buffer de entrada
                do {
                    limpiarPantalla(); // Limpiar la pantalla antes de decodificar
                    printf("Ingrese el texto a decodificar: ");
                    fgets(texto, sizeof(texto), stdin);
                    texto[strcspn(texto, "\n")] = 0; // Eliminar el salto de línea
                    decodificarCesar(texto, desplazamiento);
                    printf("¿Desea decodificar otro texto? (S/N): ");
                    continuar = getchar();
                    getchar(); // Limpiar el buffer de entrada
                } while (continuar == 'S' || continuar == 's');
                break;
            case 3:
                ...
                portada();
                system("pause");
                printf(GREEN "Saliendo del programa...\n");
                break;
            default:
        ...
        switch (opcion) {
            case 1:
                do {
                    ...
                    printf("  / ___(_)/ _|_ __ __ _ _ __  | |_ _____  _| |_ ___  \n");
                    printf(" | |   | | |_| '__/ _` | '__| | __/ _ \\ \\/ / __/ _ \\ \n");
                    printf(" | |___| |  _| | | (_| | |    | ||  __/>  <| || (_) |\n");
                    printf("  \\____|_|_| |_|  \\__,_|_|     \\__\\___/_/\\_\\\\__\\___/ \n");
            ...
            case 2:
                do {
                    limpiarPantalla();
                    printf("  ____                 _  __                  _            _        \n");
                    printf(" |  _ \\  ___  ___  ___(_)/ _|_ __ __ _ _ __  | |_ _____  _| |_ ___  \n");
                    printf(" | | | |/ _ \\/ __|/ __| | |_| '__/ _` | '__| | __/ _ \\ \\/ / __/ _ \\ \n");
                    printf(" | |_| |  __/\\__ \\ (__| |  _| | | (_| | |    | ||  __/>  <| || (_) |\n");
                    printf(" |____/ \\___||___/\\___|_|_| |_|  \\__,_|_|     \\__\\___/_/\\_\\\\__\\___/ \n");
                    printf("Ingrese el desplazamiento: ");
                    scanf("%d", &desplazamiento);
                    getchar();
                    printf("Ingrese el texto a decodificar: ");
